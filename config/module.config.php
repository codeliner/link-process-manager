...
return array(
    ...
    'service_manager' => [
        'factories' => [
            ...
            \Prooph\Link\ProcessManager\Model\Task\DisconnectMessageHandlerHandler::class => \Prooph\Link\ProcessManager\Infrastructure\Factory\DisconnectMessageHandlerHandlerFactory::class,
            \Prooph\Link\ProcessManager\Model\Task\DeactivateTaskHandler::class => \Prooph\Link\ProcessManager\Infrastructure\Factory\DeactivateTaskHandlerFactory::class,
            ...
            \Prooph\Link\ProcessManager\Service\TaskDeactivationService::class => \Prooph\Link\ProcessManager\Infrastructure\Factory\TaskDeactivationServiceFactory::class,
    ...
    'proophessor' => [
        'command_router_map' => [
            ...
            \Prooph\Link\ProcessManager\Command\Task\DisconnectMessageHandler::class => \Prooph\Link\ProcessManager\Model\Task\DisconnectMessageHandlerHandler::class,
            \Prooph\Link\ProcessManager\Command\Task\DeactivateTask::class => \Prooph\Link\ProcessManager\Model\Task\DeactivateTaskHandler::class,
        ...
        'event_router_map' => [
            ...
            \Prooph\Link\ProcessManager\Model\Workflow\TaskWasUnlinked::class => [
                \Prooph\Link\ProcessManager\Projection\Task\TaskProjector::class,
                \Prooph\Link\ProcessManager\Service\TaskDeactivationService::class,
            ],
            \Prooph\Link\ProcessManager\Model\Task\MessageHandlerWasDisconnected::class => [
                \Prooph\Link\ProcessManager\Projection\Task\TaskProjector::class,
                \Prooph\Link\ProcessManager\Service\TaskDeactivationService::class,
            ],
            \Prooph\Link\ProcessManager\Model\Task\TaskWasDeactivated::class => [
                \Prooph\Link\ProcessManager\Projection\Task\TaskProjector::class,
            ],
        ],
    ],
